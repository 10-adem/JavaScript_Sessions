...
// https://newsapi.org/v2/top-headlines?country=us&apiKey=d610f87f486f4f2c892578c04e1dc385
...
const getNews = async function () {
  ...
  try {
    ...
    if (!res.ok) {
      isError = true;
      //   throw new Error(`Something wen wrong ${res.status}`);
    }
  ...
  //?API_KEY genellikle environment  .env dosya içerisine atılır ve de GitHUB a gönderilmez,
};
